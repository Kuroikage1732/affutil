...
(function (global, factory) {
  ...
  function timeAlign(time, bpm, error, lcm) {
      ...
      var fpb = 60000 * 4 / bpm / lcm;
      var alignedTime = 0;
      var atime1 = Math.round(Math.floor(time / fpb) * fpb); // 向下取grid时间戳
      var atime2 = Math.round(Math.ceil(time / fpb) * fpb); // 向上取grid时间戳
      var abs1 = Math.abs(time - atime1); // atime1与time的距离
      var abs2 = Math.abs(time - atime2);
      var ok1 = (abs1 <= error); //abs1是否在容差内
      var ok2 = (abs2 <= error);
  ...
  Object.defineProperties( Note.prototype, prototypeAccessors );
  var NoteGroup = /*@__PURE__*/(function (Array) {
      function NoteGroup(notes) {
          var this$1$1 = this;
      ...
      if ( Array ) NoteGroup.__proto__ = Array;
      NoteGroup.prototype = Object.create( Array && Array.prototype );
      ...
      NoteGroup.prototype.push = function push () {
          ...
          objs.forEach(function (obj) {
              Array.prototype.push.call(this$1$1, obj);
          });
          return this.length;
      };
      /**
      ...
      NoteGroup.prototype.align = function align (bpm, error, lcm) {
          ...
          this.forEach(function (value, index) {
              if (value) {
                  this$1$1[index].align(bpm, error, lcm);
              }
          });
          return this;
      };

      Object.defineProperties( NoteGroup.prototype, prototypeAccessors$1 );

      return NoteGroup;
  }(Array));

  var Tap = /*@__PURE__*/(function (Note) {
  ...
  var Hold = /*@__PURE__*/(function (Tap) {
      function Hold(time, totime, lane) {
          Tap.call(this, time, lane);
          this.totime = Math.floor(totime);
      }

      if ( Tap ) Hold.__proto__ = Tap;
      Hold.prototype = Object.create( Tap && Tap.prototype );
      ...
      Hold.prototype.offsetto = function offsetto (value) {
          Tap.prototype.offsetto.call(this, value);
          this.totime += value;
          return this;
      };
      Hold.prototype.align = function align (bpm, error, lcm) {
          if ( error === void 0 ) error = 3;
          if ( lcm === void 0 ) lcm = 96;

          Tap.prototype.align.call(this, bpm, error, lcm);
      ...
      Object.defineProperties( Hold.prototype, prototypeAccessors );
  ...
  function bezier(percent, p1x, p1y, p2x, p2y) {
      if ( p1x === void 0 ) p1x = 1 / 3;
      if ( p1y === void 0 ) p1y = 0;
      if ( p2x === void 0 ) p2x = 2 / 3;
      if ( p2y === void 0 ) p2y = 1;
      ...
      function solve_curve_x(x) {
          ...
          while (t0 < t1) {
              var x2$1 = ((ax * t2 + bx) * t2 + cx) * t2;
              if (Math.abs(x2$1 - x) < 1e-6) {
                  return t2;
              }
              if (x > x2$1) {
                  t0 = t2;
      ...
      var t = solve_curve_x(percent);
      return ((ay * t + by) * t + cy) * t;
  }
  function slicer(time, fromtime, totime, fromposition, toposition, easingtype) {
      if ( easingtype === void 0 ) easingtype = 's';

      var t_offset = fromtime;
      var p_offset = fromposition;
      time -= t_offset;
      totime -= t_offset;
      toposition -= p_offset;
  ...
  var Arc = /*@__PURE__*/(function (Hold) {
      function Arc(time, totime, fromx, tox, slideeasing, fromy, toy, color, isskyline, skynote, fx) {
          if ( skynote === void 0 ) skynote = [];
          if ( fx === void 0 ) fx = 'none';

          Hold.call(this, time, totime, 1);
          this.fromx = fromx;
          this.fromy = fromy;
          this.tox = tox;
          this.toy = toy;
      ...
      prototypeAccessors.skynote.get = function () {
      ...
      prototypeAccessors.slideeasing.set = function (easingtype) {
      ...
      Arc.prototype.offsetto = function offsetto (value) {
          ...
          Hold.prototype.offsetto.call(this, value);
          if (this._skynote) {
              this._skynote.forEach(function (v, index) {
                  this$1$1._skynote[index] += value;
              });
          }
          return this;
      };
      ...
      Arc.prototype.align = function align (bpm, error, lcm) {
          ...
          Hold.prototype.align.call(this, bpm, error, lcm);
          if (this._skynote) {
              this._skynote.forEach(function (value, index) {
                  this$1$1._skynote[index] = timeAlign(value, bpm, error, lcm);
              });
          }
          return this;
      };
  ...
  var Timing = /*@__PURE__*/(function (Note) {
      function Timing(time, bpm, bar) {
          if ( bar === void 0 ) bar = 4;
      ...
      if ( Note ) Timing.__proto__ = Note;
      Timing.prototype = Object.create( Note && Note.prototype );
      Timing.prototype.constructor = Timing;
      Timing.prototype.toString = function toString () {
  ...
  var Camera = /*@__PURE__*/(function (Note) {
      function Camera(time, transverse, bottomzoom, linezoom, steadyangle, topzoom, angle, easing, lastingtime) {
          Note.call(this, time);
      ...
      if ( Note ) Camera.__proto__ = Note;
      Camera.prototype = Object.create( Note && Note.prototype );
      Camera.prototype.constructor = Camera;

      var prototypeAccessors = { easing: { configurable: true } };
      prototypeAccessors.easing.set = function (easingtype) {
      ...
      prototypeAccessors.easing.get = function () {
          return this._easing;
      };
  ...
  var Flick = /*@__PURE__*/(function (Note) {
      function Flick(time, x, y, dx, dy) {
          Note.call(this, time);
          this.x = x;
          this.y = y;
          this.dx = dx;
      ...
      if ( Note ) Flick.__proto__ = Note;
      Flick.prototype = Object.create( Note && Note.prototype );
      Flick.prototype.constructor = Flick;
      Flick.prototype.toString = function toString () {
  ...
  function sort(unsorted) {
      var sortable_timing = new NoteGroup();
      var sortable_tap = new NoteGroup();
      var sortable_hold = new NoteGroup();
      var sortable_arc = new NoteGroup();
      var sortable_camera = new NoteGroup();
      var sortable_scene = new NoteGroup();
      var sortable_group = new NoteGroup();
      var sortedlist = new unsorted.constructor.prototype.constructor();
      unsorted.forEach(function (eachnote) {
          if (eachnote) {
      ...
      sortedlist.concat(sortBy$1(sortable_camera, ['time']));
      sortedlist.concat(sortBy$1(sortable_timing, ['time']));
      sortedlist.concat(sortBy$1(sortable_scene, ['time']));
      sortedlist.concat(sortBy$1(sortable_tap, ['time', 'lane']));
      sortedlist.concat(sortBy$1(sortable_hold, ['time', 'lane', 'totime']));
      sortedlist.concat(sortBy$1(sortable_arc, ['time', 'fromx', 'fromy', 'totime', 'tox', 'toy']));
      sortedlist.sort(function (a, b) { return a.time - b.time; });
      sortedlist.concat(sortable_group);
      return sortedlist;
  }

  var AffList = /*@__PURE__*/(function (NoteGroup) {
      function AffList(notes, offset, desnity) {
          if ( notes === void 0 ) notes = [];
          if ( offset === void 0 ) offset = 0;
          if ( desnity === void 0 ) desnity = 1;

          NoteGroup.call(this, notes);
          this.offset = Math.floor(offset);
          this.desnity = Math.floor(desnity);
      }

      if ( NoteGroup ) AffList.__proto__ = NoteGroup;
      AffList.prototype = Object.create( NoteGroup && NoteGroup.prototype );
      AffList.prototype.constructor = AffList;
      AffList.prototype.toString = function toString () {
          var tsdfstring = '';
          if (this.desnity != 1) {
          ...
          return [
              ...
              NoteGroup.prototype.toString.call(this)
          ].join('\n');
      };
      AffList.prototype.offsetto = function offsetto (value) {
          var this$1$1 = this;
          ...
          this.forEach(function (each, index) {
              if (each) {
                  this$1$1[index].offsetto(value);
              }
          });
  ...
  var TimingGroup = /*@__PURE__*/(function (NoteGroup) {
      function TimingGroup(notes, opt) {
          if ( notes === void 0 ) notes = [];
          if ( opt === void 0 ) opt = '';
      ...
      if ( NoteGroup ) TimingGroup.__proto__ = NoteGroup;
      TimingGroup.prototype = Object.create( NoteGroup && NoteGroup.prototype );
      TimingGroup.prototype.constructor = TimingGroup;
      TimingGroup.prototype.toString = function toString () {
          var group = "timinggroup(" + (this.option) + "){";
          this.forEach(function (each) {
              group += "\n" + (each.toString());
          });
          group += '\n};';
      ...
      TimingGroup.prototype.push = function push () {
          var this$1$1 = this;
          var objs = [], len = arguments.length;
          while ( len-- ) objs[ len ] = arguments[ len ];

          objs.forEach(function (obj) {
              NoteGroup.prototype.push.call(this$1$1, obj);
          });
          return this.length;
      };
      TimingGroup.prototype.offsetto = function offsetto (value) {
          var this$1$1 = this;
  ...
  function parseLine$1(notestr) {
      ...
      var keyword = _notestriter(tempnotestr, '(');
      tempnotestr = tempnotestr.slice(keyword.length + 1, tempnotestr.length);
      var parastr = _notestriter(tempnotestr, ')');
      var paralist = parastr.split(',');
      tempnotestr = tempnotestr.slice(parastr.length + 1, tempnotestr.length);
      var sub_expression = _notestriter(tempnotestr, ';');
      tempnotestr = tempnotestr.slice(keyword.length + 1, tempnotestr.length);
      if (keyword == '' && paralist) {
          return new Tap(parseInt(paralist[0]), parseInt(paralist[1]));
      }
      else if (keyword == 'hold') {
          return new Hold(parseInt(paralist[0]), parseInt(paralist[1]), parseInt(paralist[2]));
      }
      else if (keyword == 'arc') {
          var isskyline;
          if (paralist[9] == 'true') {
          ...
          var skynotetimelist = [];
          if (sub_expression) {
              var splited = sub_expression.split(',');
              splited.forEach(function (each) {
                  skynotetimelist.push(parseInt(each.slice(each.indexOf('(') + 1, each.indexOf(')'))));
              });
          }
          return new Arc(parseInt(paralist[0]), parseInt(paralist[1]), parseFloat(paralist[2]), parseFloat(paralist[3]), paralist[4], parseFloat(paralist[5]), parseFloat(paralist[6]), parseInt(paralist[7]), isskyline, skynotetimelist, paralist[8]);
      }
      else if (keyword == 'timing') {
          return new Timing(parseInt(paralist[0]), parseFloat(paralist[1]), parseFloat(paralist[2]));
      }
      else if (keyword == 'camera') {
          return new Camera(parseInt(paralist[0]), parseFloat(paralist[1]), parseFloat(paralist[2]), parseFloat(paralist[3]), parseFloat(paralist[4]), parseFloat(paralist[5]), parseFloat(paralist[6]), paralist[7], parseInt(paralist[8]));
      }
          ...
          var temptg = new TimingGroup([], paralist.join(','));
          return temptg;
      }
      return noteobj;
  }
  function parse$1(affstr) {
      ...
      var tempstruct;
      notestrlist.forEach(function (eachline) {
          var stripedlinestr = eachline.trim();
